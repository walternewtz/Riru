...
add_file $FILESDIR/lib/arm64-v8a/libriru64.so $RIRUDIR/lib64/libriru64.so
add_file $FILESDIR/lib/armeabi-v7a/libriruhide.so $RIRUDIR/lib/libriruhide.so
add_file $FILESDIR/lib/arm64-v8a/libriruhide64.so $RIRUDIR/lib64/libriruhide64.so
add_file $FILESDIR/lib/armeabi-v7a/libriruloader.so $RIRUDIR/system/lib/libriruloader.so
add_file $FILESDIR/lib/arm64-v8a/libriruloader64.so $RIRUDIR/system/lib64/libriruloader64.so
add_file $FILESDIR/lib/armeabi-v7a/libriruloader.so /system/lib/libriruloader.so
add_file $FILESDIR/lib/arm64-v8a/libriruloader64.so /system/lib64/libriruloader64.so
